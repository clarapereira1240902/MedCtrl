    ...
    <div class="row">
        ...
        <main class="col-lg-10 p-4">
            ...
            <div class="page-header">
                <h2>
                    <i class="fa-solid fa-file-medical me-2"></i>Listagem de Documentos
                </h2>
                    ...
                    <div class="d-flex gap-2 flex-wrap align-items-center">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="exportar_csv.php?pesquisa=<?php echo urlencode($pesquisa); ?>&tipo_documento_id=<?php echo urlencode($tipo_documento_id); ?>&validade=<?php echo urlencode($validade); ?>&situacao=<?php echo urlencode($situacao); ?>">
                                        <i class="fa-solid fa-file-csv me-2"></i>CSV
                                    </a>
                                </li>

                                <li>
                                    <a class="dropdown-item" href="relatorio.php?pesquisa=<?php echo urlencode($pesquisa); ?>&tipo_documento_id=<?php echo urlencode($tipo_documento_id); ?>&validade=<?php echo urlencode($validade); ?>&situacao=<?php echo urlencode($situacao); ?>" target="_blank">
