        ...
        <main class="col-lg-10 p-4">
            ...
            <?php if ((int) $equipamento->ativo === 0) : ?>
                <div class="alert alert-warning">
                    ...
                    Este equipamento encontra-se inativo.
                </div>
            <?php endif; ?>
            ...
            <div class="card-medctrl">
                <div class="row">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="editar.php?id=<?php echo $equipamento->id; ?>" class="btn btn-edit btn-sm">
                            <i class="fa-solid fa-pen me-1"></i> Editar
                        </a>

                        <?php if ((int) $equipamento->ativo === 1) : ?>

                            <a href="apagar.php?id=<?php echo $equipamento->id; ?>" class="btn btn-delete btn-sm">
                                <i class="fa-solid fa-ban me-1"></i> Inativar
                            </a>

                        <?php else : ?>

                            <a href="apagar.php?id=<?php echo $equipamento->id; ?>" class="btn btn-success btn-sm">
